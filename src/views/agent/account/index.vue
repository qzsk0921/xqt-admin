    ...
    <div class="account">
        ...
        <el-row class="pagination-row">
            <el-pagination
                :page-size="10"
                :pager-count="11"
                :page-count="parseInt(pagination.totalCount)"
...
<script>
    import { agentLog, agentAmount } from "../../../api/agent";
    ...
    export default {
        ...
        methods: {
            ...
            handleAgentLog () {
                agentLog({page: this.currentPage}).then(res => {
                    if (res.result == 1) {
                        this.listData = res.data.list
                        this.pagination = res.eata.pagination
                    }
                }).catch(errors => {
                    console.log(errors)
                })
